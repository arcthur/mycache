...
const BLOB_TYPE_PREFIX = '~~mycache_type~';
const BLOB_TYPE_PREFIX_REGEX = /^~~mycache_type~([^~]+)~/;
...
function serialize(value: any, callback: any) {
  let valueType = '';
  if (value) {
...
export { serialize, deserialize, stringToBuffer, bufferToString };
